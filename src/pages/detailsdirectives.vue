      ...
      <div style="border-radius: 45px; width:100%; height: 647px; position: absolute; top:280px; " class=" rounded-borders bg-white q-pa-md  q-gutter-xs">
        ...
        <div class="row q-py-xl ">
          ...
          <q-btn-group class="row full-width" rounded>
            <q-btn color="white" class=" col-6 text-black" rounded glossy icon="arrow" label="Ingredients" :to="'/detailsinstructions/' + $route.params.id" />
            <q-btn color="secondary" class="col-6" rounded glossy icon="arrow"  label="Directives" />
          </q-btn-group>
        ...
        <div class="items-start q-gutter-md q-pa-md">
          <q-card v-for="(item,index) in Ingredients" :key="index" dark bordered class="bg-white my-card row  " style=" border-radius: 20px; height:100%;">
            ...
            <q-separator vertical color="secondary" inset />
            <div class="col q-pa-xs q-gutter-xs">
              <div class="row q-pt-md">
                ...
                <div style="height: 100%; font-size: 16px; font-weight: 400; line-height: 26px; font-family: 'EB Garamond'; color: rgb(0, 0, 0);" class="col-4">time: {{item.time}} mns</div>
              </div>
            </div>
            <q-separator vertical color="secondary" inset />
        ...
        <div class="row">
          ...
          <q-btn
            ...
            @click="Add(addvaluename,addvaluetime)"
          />
        </div>
      </div>
  </q-page>
...
export default defineComponent({
  ...
  methods:{
    ...
    async Modify(ref,id){
      await db.collection('Directives')
      .doc({ ref:ref, id:id })
      .update({
      name: this.valuename,
      time: this.valuetime,
   ...
   async Delete(ref,id){
      await db.collection('Directives').doc({ ref: ref, id:id }).delete()
      this.detail()
    },
    async Add(name, time){
      var a
      ...
      await db.collection('Directives').add({
        ref: a ,
        name: name,
        time: time,
